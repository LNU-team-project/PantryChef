...
| Роль | Можливості |
| :--- | :--- |
| **🔓 Гість** | Перегляд лендінгу, публічного каталогу рецептів, фільтрація, реєстрація. |
| **🔐 Користувач** | Керування холодильником, персональні рекомендації, контроль калорій, налаштування обмежень. |

---

## Переваги PantryChef
1. **Zero Waste:** Допомагає використовувати продукти до закінчення терміну придатності.
2. **Health First:** Автоматизує рутинні розрахунки калорій.
3. **Scalability:** Архітектура дозволяє легко додавати нові модулі (наприклад, інтеграцію з зовнішніми API).

---
*Generated by PantryChef Team © 2026*
